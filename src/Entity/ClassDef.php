...
class ClassDef
{
    ...
    #[Vich\UploadableField(mapping: 'class_logo', fileNameProperty: 'logoName')]
    ...
    #[ORM\JoinTable(name: 'class_def_skill')]
    ...
    public function addBaseSkill(Skill $baseSkill): static
    {
    ...
    public function removeBaseSkill(Skill $baseSkill): static
    {
